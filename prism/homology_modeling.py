...
def run_automodel(env: Environ, align_file: str, job: Job,
                  residues_to_freeze: Set[int]) -> List[str]:
    """
    ...
    Args:
        ...
        residues_to_freeze: Set of residue numbers that must NOT be optimized
    ...
    print(f"[STEP 3] 🔒 FIXED MODE: {len(residues_to_freeze)} experimental residues will NOT be optimized")
    print(f"{'='*80}\n")
