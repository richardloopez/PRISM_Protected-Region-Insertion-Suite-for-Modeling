...
class InputMode(Enum):
    NORMAL = "normal"
    USE_PRECOMPUTED_FILES = "precomputed"
    RSR_INI_PRECALCULATION = "precalculation"

INPUT_MODE = InputMode.precomputed

USE_MANUAL_OPTIMIZATION_SELECTION = False
MANUAL_OPTIMIZATION_RESIDUES = []
...
__all__ = [
    ...
    'MIN_DIST_FROM_NUCLEOTIDE_COM', 'REFINE_FLANKS_DURING_AUTOMODEL', 'EXPERIMENTAL_FLANK_SIZE', 'INPUT_MODE',
    'USE_MANUAL_OPTIMIZATION_SELECTION', 'MANUAL_OPTIMIZATION_RESIDUES',
